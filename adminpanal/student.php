...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result) {
        ...
        $mail->SMTPSecure='ssl';
        $mail->Port=465;
        $mail->setFrom('abdullahalsakib705@gmail.com');
        $mail->addAddress($email);
        $mail->Subject="Your Login Info ";
        $mail->Body="Your User Name is : $id  $ok  Your Password is : $password ";
        $mail->send();
...
<head>
    <meta charset="utf-8">
    <title>UMOS Admin Students</title>
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/mehrab.jpg" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1">
                        </div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">Mehrab Khan</h6>
                        <span>Admin</span>
                    </div>
                </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <img class="rounded-circle me-lg-2" src="img/mehrab.jpg" alt="" style="width: 40px; height: 40px;">
                                <span class="d-none d-lg-inline-flex">Mehrab Khan</span>
                            </a>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="">Team PathFinders</a>
                            <br>
                        </div>
                    </div>
                </div>
