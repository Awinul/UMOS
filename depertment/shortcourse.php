...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO `shortcourse`( `name`, `cid`, `department`, `length`) VALUES ('$name','$id','$department','$length')";
                           ...
                           <!-- <label for="lname">Faculty Name:</label>
                            <form method="POST" class="searchform order-lg-last" style="text-align: center;">
                                ...
                                <div class="" style="text-align: center;">
                                    ...
                                    <input style="width:300px; border:3px solid #FFA500;" type="text" class=""
                                        placeholder="Search By Id" name="addteacher">
                                    <button style="width:40px; background-color: #4CAF50;" type="submit" name="pro"
                                        placeholder="" class=""><span class="fa fa-search"></span></button>
                                </div>
                            </form> -->
                            ...
                            <form action="" method="POST" autocomplate='off'>
                                ...
                                <label for="lname">Length of the course :</label>
                            ...
                            <table class="table table-dark">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo"<a href='shortcourseedit.php?id=$id'> <button type='button' class='btn btn-primary'>Edit</button> </a>" ?>
</td>
                                    </tr>
