<?php
session_start();
if(!isset($_SESSION['depertment_name'])){
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($results) {
    ...
    $sql = "INSERT INTO `uapermission`(`tid`, `tname`) VALUES ('$name','$tname')";
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/Logo_uiu.jpg" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo $_SESSION['depertment_name'] ?></h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="shortcourse.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>short course</a>
                    ...
                    <a href="ta.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>UA</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <img class="rounded-circle me-lg-2" src="img/Logo_uiu.jpg" alt="" style="width: 40px; height: 40px;">
                                <span class="d-none d-lg-inline-flex"><?php echo $_SESSION['depertment_name'] ?></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">

                                <a href="depertmentlogout.php" class="dropdown-item">Log Out</a>
                            </div>
                        </div>
                    </div>
            </nav>
...
$sql = "SELECT * FROM `teacher` where department='CSE'";
...
echo "  <option value='$id'>Teacher Name: $name Id: $id</option>";
