        ...
        <div class="container-xxl py-5 category">
            <div class="container">
                ...
                $sid = $_SESSION['teacher_id'];
                    $sa = "SELECT * FROM shortcourse INNER JOIN shortcoursefaculty ON shortcourse.id=shortcoursefaculty.cid WHERE shortcoursefaculty.fid='$sid'";
                ...
                echo"
                  ...
                  <div class='col-sm'>
                      ...
                      <a class='position-relative d-block overflow-hidden' href='shortcoursehome.php?id=$id'>
                       <img class='img-fluid' style='width:300px;' src='../navbar/uploads/$image' alt=''>
