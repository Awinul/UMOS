...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content border-radius-lg ">
    ...
    <table class="table table-striped">
      ...
      <?php
      $sql = "SELECT * FROM `course` WHERE Occupied > '34'";
      ...
      ?>
        <tbody>
          <tr>
            ...
            <td><?php echo " <a href='t_ss.php?id=$id&&section=$section'><button type='button' class='btn btn-primary'>View</button></a> "; ?></td>
          </tr>
    ...
    <table class="table table-striped">
      ...
      <?php
      $sql = "SELECT * FROM `ta` ORDER BY(oid) DESC ";
    ...
    <!-- <a href='public_ua_list.php'><button type='button' class='btn btn-info'>Public  UA List</button></a> -->
