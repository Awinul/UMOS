...
<!-- End Navbar -->
  ...
  $sql = "SELECT * FROM `apply` WHERE cid='$id' AND section='$section' ORDER BY(cgpa) DESC";
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    $section=$row['section'];
    $zid=$row['tid'];
    $sql1 = "SELECT * FROM `ta` WHERE sid='$id'";
    $result1 = mysqli_query($conn, $sql1);
    $acc=" ";
    while ($row1 = mysqli_fetch_array($result1)) {
      
     
      $acc = $acc . "," . $row1['cname'] . "(" . $row1['section'] . ")";
    ...
    <div class='col-sm'>
     <div>
         ...
         <p>CGPA : $cgpa </p>
         <p>Current UA : $acc</p>
         <a href='show_student_profile.php?id=$id'><button type='button' class='btn btn-primary'>View Profile</button></a>
         <a href='taaddapi.php?name=$name&&id=$id&&cname=$cname&&cid=$cid&&section=$section&&tid=$zid'><button type='button' class='btn btn-success'>Add</button></a>
