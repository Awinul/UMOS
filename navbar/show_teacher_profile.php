                ...
                <div class="card p-3 py-4">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <?php 
                         ...
                         ?>
                         <tbody>
                          <td   style="color:black"><b><?php echo $day ?></b></td>
                            <td style="color:black"><b><?php  echo $start ?> </b></td>
                            <td style="color:black"><b> <?php  echo $end ?></b></td>
                        ...
                        <?php
                        $ti = date("Y-m-d");
                         $v= "SELECT * FROM `bokking` WHERE tid='$id'";
                         $e = mysqli_query($conn, $v);
                         while ($rowe = mysqli_fetch_array($e)) {
                            $day = $rowe['day'];
                            $start = $rowe['start'];
                         ...
                         if($ti<$date){
                          ...
                          <td   style='color:black'><b>  $date </b></td>
                           <td   style='color:black'><b>  $day </b></td>
                             <td style='color:black'><b>  $start </b></td>
                             <td style='color:black'><b>    $end </b></td>
