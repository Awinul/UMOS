...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content border-radius-lg ">
        ...
        <?php
        $sq = "SELECT * FROM `shortcourse` WHERE id='$cid'";
        $result = mysqli_query($conn, $sq);
        $data = $result->fetch_assoc();
        if ($result) {
            $name = $data["name"];
        ...
        ?>
        <br>
        <?php echo "<form action= 'uploadss.php?weak=$weak' method='post' enctype='multipart/form-data'>" ?>
        <h1 style="text-align:center;color:burlywood">Add Videos</h1>
        <p>Title</p>
        ...
        <div class='container'>
            ...
            <div class='video-list'>
                <div class='vid active'>
                    ...
                    <h3 class='title'><?php echo $title ?></h3>
                    <?php echo"<a href='coursevideodelet.php?id=$id&&week=$weak'  style='color:red'><h5><i class='fa fa-trash' aria-hidden='true'></i></h5></a>" ?>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    if ($name == $one) {
                       ...
                       <a href='coursevideodelet.php?id=$id&&week=$weak' <h5 style='color:red'><i class='fa fa-trash' aria-hidden='true'></i></h5></a>
