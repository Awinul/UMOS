...
<li class="nav-item">
  <a class="nav-link text-white " href="applyua.php">
    
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="material-icons opacity-10">view_in_ar</i>
      </div>
    
    <span class="nav-link-text ms-1">Apply for U.A</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="Coursemet.php">
    ...
    <span class="nav-link-text ms-1">Completed Course</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="./book/allbook.php">
...
<!-- End Navbar -->
  ...
  <h2 style="text-align: center;"class="font-weight-bolder mb-0">All Courses</h2>
  <br>
</div>
  ...
  top: 380px; left: 540px;
" class="copyright text-center text-sm text-muted text-lg-start">
          <h4>© 2023
          made  by
          <a href="" class="font-weight-bold" target="_blank">Team PathFinders</a></h4>
