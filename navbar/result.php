  ...
  <thead>
    <tr>
      ...
      <th scope="col">Status</th>
        ...
        <?php
        $sql = " SELECT DISTINCT(sid),sname   FROM `participants` WHERE ename='$name' AND cid='$cid' AND week='$weak'";
    ...
    <tr>
      ...
      <td><?php echo "<a href='showresult.php?id=$sid'><p style='color:blue'>$sname </p></a>" ?></td>
      <td><?php echo $sid ?></td>
      <?php 
      $sql1 = "SELECT DISTINCT(sid) FROM `mark` WHERE sid='$sid' AND ename='$name'";
            $result1 = mysqli_query($conn, $sql1);
            while ($row1 = mysqli_fetch_array($result1)) {
                
      echo"<td> <h5 style='text-align:center; color:green;'>Public <i class='fa fa-check' aria-hidden='true'></i></h5></td>"; ?>
    </tr>
