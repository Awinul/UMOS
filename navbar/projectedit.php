                            ...
                            <h3> ADD Project Partner<h3>
                                    ...
                                    <form method="POST" class="searchform order-lg-last" style="text-align: center;">
                                        ...
                                        <div class="" style="text-align: center;">
                                            ...
                                            <input style="width:300px; border:3px solid #FFA500;" type="text" class="" placeholder="Search By Id" name="addpartner">
                                            <button style="width:40px; background-color: #4CAF50;" type="submit" name="pro" placeholder="" class=""><span class="fa fa-search"></span></button>
                                        </div>
                                    </form>
                                    <br>
                                    <label for="lname">
                                    ...
                                    <h3>Add Faculty<h3>
                                            ...
                                            <form method="POST" class="searchform order-lg-last" style="text-align: center;">
                                                ...
                                                <div>
                                                    ...
                                                    <input style=" width:300px; border:3px solid #FFA500; " type="text"  placeholder="Search" name="addpartner">
