...
<div class="row gutters-sm">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                        <h4><?php echo $name; ?></h4>
                        <p class="text-secondary mb-1">Student ID: <?php echo $sid; ?></p>
    ...
    <div class="col-md-8">
        ...
        <div>
            ...
            $sa = "SELECT * FROM `education` WHERE sid='$sid'";
            ...
            ?>
                ...
                <div>
                    ...
                    $sa = "Select * from project where sid='$sid'";
                    $resulta = mysqli_query($conn, $sa);
                    while ($row = mysqli_fetch_array($resulta)) {
                        $id = $row['project_id'];
                ...
                <div><?php
                        ...
                        $saw = "Select * from experience where sid='$sid'";
        ...
        <h1 style="text-align: center"> ACHIEVEMENTS </h1>
            ...
            $sa = "SELECT * FROM `achievements` WHERE sid='$sid'";
            $resulta = mysqli_query($conn, $sa);
            while ($row = mysqli_fetch_array($resulta)) {
                $id = $row['id'];
