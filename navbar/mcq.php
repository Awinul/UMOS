...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `mcq`( `cid`, `ename`, `week`, `qus`, `option1`, `option2`, `option3`, `option4`,answer,time,image) VALUES ('$cid','$ename','$weak','$qname','$op1','$op2','$op3','$op4','$ans','$time','$new_img_name')";
    ...
    <main class="main-content border-radius-lg ">
        ...
        <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div style="padding-left:40px;">
                ...
                <textarea name='qname' id='qname' placeholder='Qustion'></textarea>
        ...
        <input name='op1' id='ename' placeholder='Option 1'><br><br>
        <input name='op2' id='ename' placeholder='Option 2'><br><br>
        <input name='op3' id='ename' placeholder='Option 3'><br><br>
        <input name='op4' id='ename' placeholder='Option 4'><br>
        <br>
        <input name='ans' id='ename' placeholder='Answer'><br>
        <br>
...
<div style='text-align:center;'>
        ...
        <div style="text-align: center">
            ...
            <?php
            $sql = "SELECT * FROM `mcq` WHERE cid='$cid' AND ename='$ename' AND week='$weak'";
    ...
    <h4> <b> Qustion: $qus</b><a href='mcqdelete.php?id=$id'> <i class='fa fa-trash' aria-hidden='true'></i></a></h4>
   <h6> Option 1:$ops1 </h6>
   <h6> Option 2:$ops2 </h6>
   <h6> Option 3:$ops3 </h6>
   <h6> Option 4:$ops4 </h6>
