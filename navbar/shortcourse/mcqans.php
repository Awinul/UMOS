...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content border-radius-lg ">
    ...
    //         <h4>You have not submitted your answer. Please retry the test</h4>
            
    //         </div>";
    // } else {
      echo "<div style='  text-align: center; border: 1px solid black;'>
            <h4>Your mark is $k out of $z</h4>
            
            </div>";
      $sa = 0;
      $sid = $_SESSION['student_id'];
      $names = $_SESSION['examname'];
     
         
      
        $sql = "INSERT INTO `mark`( `ename`, `week`, `sid`, `mark`, `tmark`,cid) VALUES ('$names','$sweak','$sid','$k','$z','$scid')";
