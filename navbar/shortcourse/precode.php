  ...
  <main class="main-content border-radius-lg ">
    ...
    while ($row = mysqli_fetch_array($result)) {
      ...
      echo "
           ...
           <a href='mycodeexam.php?id=$id'> <h5>Qustion $s :$qus </a>";


      $sql1= "SELECT DISTINCT(qid),sanme,sid,ans,mark,qus FROM `codemark` WHERE sid='$tid' AND week='$sweak' AND ename='$name' AND eid='$scid' AND qid='$qid'";
