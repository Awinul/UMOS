...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content border-radius-lg ">
    ...
    <div style='padding-left: 90px;'>
      ...
      $sql = "SELECT DISTINCT(ename),time FROM `mcq` WHERE cid='$scid' AND week='$sweak'";
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        echo "
            ...
            <div>
                                    <a type='button' class='btn btn-success' href='#popup1'>Start Exam</a>
                                </div>


                                <div id='popup1' class='overlay'>
                                <div class='popup'>
                                    <h2>Start Notification</h2>
                                    <a class='close' href='#'>&times;</a>
                                    <div class='content'>
                                    Are you sure to Start the Exam?
                                    <br>
                                    <a href='timer.php?name=$name&&time=$time&&id=1'><button type='button' class='btn btn-primary'>Start Exam</button></a>
    ...
    <div style='padding-left: 90px;'>
      ...
      $sql = "SELECT DISTINCT(ename),time FROM `code` WHERE cid='$scid' AND week='$sweak'";
      $result = mysqli_query($conn, $sql);
      while ($row = mysqli_fetch_array($result)) {
        $name = $row['ename'];
        $time = $row['time'];
        ...
        echo "
            ...
            <div>
            <a type='button' class='btn btn-success' href='#popup2'>Start Exam</a>
        </div>
        ...
        <div class='popup'>
            ...
            <br>
            <br>
            <a href='timer.php?name=$name&&time=$time&&id=2'><button type='button' class='btn btn-primary'>Start Exam</button></a>
            <div>
            <br>
