      ...
      <div class="container-xxl py-5 category">
            <div class="container">
                ...
                <div class="row">
                    ...
                    $sa = "SELECT * FROM enroll INNER JOIN shortcourse on enroll.cid=shortcourse.id WHERE enroll.sid='$tid'";
                ...
                echo"
                  ...
                  <div class='col-sm'>
                      ...
                      <a class='position-relative d-block overflow-hidden' href='home.php?id=$id'>
