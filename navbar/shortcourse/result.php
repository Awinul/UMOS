...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content border-radius-lg ">
        ...
        <h2 style="text-align: center;">My Result</h2>
        <table class="table">
            ...
            $s = 0;
            $sql = "SELECT  DISTINCT(ename)  FROM `mark` WHERE sid='$tid' AND week='$sweak' ";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_array($result)) {
                $examname = $row['ename'];
                $sql1 = "SELECT  MAX(mark) as mk,sid,week,tmark FROM `mark` WHERE sid='$tid' AND week='$sweak' AND ename='$examname' ";
            ...
            ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $row1['week']; ?></td>
                            <td><?php echo $row1['mk']; ?></td>
                            <td><?php echo $row1['tmark']; ?></td>
                        </tr>
