...
$sql5 = " INSERT INTO `participants`( `ename`, `cid`, `week`, `sname`, `sid`) VALUES ('$name','$scid','$sweak','$sname','$tid')";
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content border-radius-lg ">
    ...
    <?php echo " <form action='mcqans.php' method='POST' style='padding-left:400px;'>" ?>
    <?php

    $s = 1;
    $sql = "SELECT * FROM `mcq` WHERE cid='$scid' AND week='$sweak' And ename='$name'";
    ...
    while ($row = mysqli_fetch_array($result)) {
      ...
      echo "
            ...
            if($image!=null) {
              echo" <img style='width: 300px; height:200px'src='../uploads/$image' alt=''></img>
              <br>";
            }
            
           
            echo"<h5>Qustion $s :$qus<h5>
            <br>
            

            A. <input type='radio' name='$s' value='$op1' >$op1 <br>
            B. <input type='radio' name='$s' value='$op2' >$op2 <br>
            C. <input type='radio' name='$s' value='$op3' >$op3 <br>
            D. <input type='radio' name='$s' value='$op4'>$op4 <br>
...
<br>
    ...
    <div id="overlay">
      <div id="popup">
        ...
        <p>Click Submit button For submit </p>
